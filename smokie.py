...
ADMIN_IDS = [809680839]  # Changed from string to list of integers
BOT_TOKEN = "7135876540:AAHiMc8TmuOhAooVKjqu73KbwqTBnUgBPlQ"
...
async def run_attack_command_on_codespace(target_ip, target_port, duration, chat_id):
    ...
    try:
        ...
        output = stdout.decode().replace("", "@Hmm_Smokie")
        error = stderr.decode()
